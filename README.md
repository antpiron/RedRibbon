...
In R, download RedRibbon_1.4-1.tar.gz on github, and then the run

```bash
R CMD INSTALL RedRibbon_1.4-1.tar.gz
```
...
```bash
tar xvzf  credribbon-1.3.tar.gz
cd credribbon-1.3
./configure
make
sudo make install
