...
main(int argc, char *argv[argc])
{
  ...
  rrho_rectangle_min(&rrho, 0, 0, n, n, &(struct rrho_rectangle_params){ .m = n, .n = n }, RRHO_HYPER, 1, &coord);
  ...
  ret = rrho_rectangle_min(&rrho, 0, 0, n, n, &(struct rrho_rectangle_params){ .m = n, .n = n }, RRHO_HYPER_TWO_TAILED, -1, &coord);
