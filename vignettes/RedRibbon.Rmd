...
RedRibbon is capable of handling both long and short reads differential analyses.
To illustrate this, we will compare the signatures of long (GSE167223) and short reads (GSE137136) for pancreatic beta cells exposed to cytokines. 

This dataset is included in package and can be loaded with
...
One of the interesting overlap comparison is between transcriptome and proteome for the same cells and treatments as it allows to see if changes in transcriptome recapitulate in the proteome. 
